        ...
        <footer className="bg-primary-900 text-neutral-300">
            <div className="container py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    {/* Brand */}
                    <div>
                        <h3 className="text-2xl font-bold gradient-text mb-4">TradePro</h3>
                        ...
                        <div className="flex gap-4">
                            <a
                                href="#"
                                className="w-10 h-10 rounded-full bg-neutral-800 hover:bg-accent-blue transition-colors flex items-center justify-center"
                                aria-label="Discord"
                            >
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a href="#challenges" className="text-sm hover:text-white transition-colors">
                                    Challenges
                                </a>
                            </li>
                            <li>
                ...
                <div className="pt-8 border-t border-neutral-800">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <p className="text-xs text-neutral-500 max-w-2xl text-center md:text-right">
